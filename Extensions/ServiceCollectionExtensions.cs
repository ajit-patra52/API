...
namespace WebAPI6.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddScopedServices(this IServiceCollection services)
        {
            ...
            _ = services.AddScoped<IUnitOfWork, UnitOfWork.UnitOfWork>(); // Fully qualify the UnitOfWork class to avoid namespace conflict
            ...
            _ = services.AddScoped<IEmployeeServices, EmployeeService>();
